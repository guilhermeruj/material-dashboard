<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://adm.saearaguari.com.br " target="_blank">
        <span class="ms-1 font-weight-bold text-white">Administrativo SAE</span><br />
...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        ?>
            <li class="nav-item">
                <a class="nav-link text-white " href="esic.php">
        ...
        ?>
            <li class="nav-item">
                <a class="nav-link text-white " href="ouvidoria.php">
