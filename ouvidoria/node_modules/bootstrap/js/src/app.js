...
function mascaraCPF(cpf) {
  ...
  cpf = cpf.replace(/(\d{3})(\d)/, "$1.$2"); // coloca ponto após os primeiros 3 digitos
  cpf = cpf.replace(/(\d{3})(\d)/, "$1.$2"); // coloca ponto após os segundos 3 digitos
  cpf = cpf.replace(/(\d{3})(\d{1,2})$/, "$1-$2"); // coloca hífen antes dos últimos 2 digitos
  return cpf;
}
